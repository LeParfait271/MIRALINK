...
- Current site version: `0.54`
- Current firmware version: `0.54` (re-arms an explicitly requested teardown before pairing; USB audio remains source-only)
...
offline shell. Version `0.54` keeps the quick-access navigation introduced in
