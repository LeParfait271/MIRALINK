...
- Current site version: `0.59`
- Current firmware version: `0.59` (DS5-style ACL/SSP/HID lifecycle for passive PS reconnect; USB audio remains source-only)
...
offline shell. Version `0.59` keeps the quick-access navigation introduced in
