...
- Current site version: `0.55`
- Current firmware version: `0.55` (gates Bluetooth bootstrap and outputs on ACL encryption; USB audio remains source-only)
...
offline shell. Version `0.55` keeps the quick-access navigation introduced in
