...
- `2026-08-16` — Le candidat `0.60` supprime l'attente impossible de `SET_PROTOCOL` sur le chemin HID entrant en mode Report. Le build et le test hôte passent; le comportement matériel reste à valider.
