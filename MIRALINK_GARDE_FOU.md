...
- Version publique actuelle du site : `0.24`
...
- Version initiale : `0.1.0`.
- Chaque commit qui modifie le site ou l'application augmente la version publique de `0.01` : `0.10` → `0.11` → `0.12` → … → `0.23` → `0.24`. La version technique du paquet npm utilise `0.24.0` pour respecter le format semver, tandis que la version affichée et livrée du site reste `0.24`.
...
- `2026-08-13` — La version publique du site MiraLink est `0.24` et augmente de `0.01` par commit de site/application ; la version firmware reste indépendante et courante `2.2.0`.
