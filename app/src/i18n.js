...
const RUNTIME_EN = Object.freeze({
  audioBufferUnavailableHint: 'Unavailable in 0.39 — USB audio transport is not exposed.',
  psShortcutUnavailableHint: 'Unavailable in 0.39 — the current firmware does not expose this command.'
});

const RUNTIME_FR = Object.freeze({
  audioBufferUnavailableHint: 'Indisponible en 0.39 — le transport audio USB n’est pas exposé.',
  psShortcutUnavailableHint: 'Indisponible en 0.39 — cette commande n’est pas exposée par le firmware actuel.'
});
