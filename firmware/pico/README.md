...
- In the compiled `0.42` candidate, a build-generated SDK source patch also
...
compile time, and the UF2 is inspected locally for Pico 2 W / RP2350 ARM Secure
 targeting. The Windows host-test executable is not launched during the 0.42
...
Reconnect after power-off, after Pico reboot and after abrupt range/power loss,
idle-resume recovery, plus explicit USB re-enumeration, motion, touch, rumble,
adaptive triggers and wake still require a fresh manual `0.42` hardware test.

## Local manual-test candidate

`firmware/releases/0.42/` contains ELF, BIN, HEX, UF2 and SHA-256 values
...
The release UF2 is 1,411,072 bytes, covers `0x10000000..0x100ac294`, and has
SHA-256
`AB734548F183B85EA3ED91AD1E7AF24F1203DADFACFCB2E66F2AB3B4044EE060`.
These values establish artifact identity only; firmware `0.42` remains
