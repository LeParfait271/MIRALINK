...
Firmware 0.50 keeps the one-root experimental DualSense-family USB persona and
...
until a physical Pico 2 W validation is complete. Version `0.50` retains the
