...
La version publique actuelle du site est `0.57`. Le paquet npm peut représenter
cette même version sous la forme technique `0.57.0`, mais l'application, le
...
La correction firmware `0.57` vient d'une comparaison directe avec DS5Dongle
