# MiraLink 0.55 / DS5Dongle comparison
...
| Axis | DS5Dongle | MiraLink 0.54 | MiraLink 0.55 | Evidence |
| --- | ---: | ---: | ---: | --- |
| Passive Bluetooth reconnect | 100% | 55% | 55% | Authenticated inbound ACL, stale-CID rearm and encryption gate built; physical result pending |
...
The 0.55 UF2 is 905,216 bytes versus 1,525,248 bytes for the DS5Dongle
