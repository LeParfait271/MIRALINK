# MiraLink 0.56 / DS5Dongle comparison
...
| Axis | DS5Dongle | MiraLink 0.55 | MiraLink 0.56 | Evidence |
| --- | ---: | ---: | ---: | --- |
| Passive Bluetooth reconnect | 100% | 55% | 55% | Explicit gamepad ACL acceptance now mirrors DS5Dongle; physical result pending |
...
The 0.56 UF2 is 905,728 bytes versus 1,525,248 bytes for the DS5Dongle
