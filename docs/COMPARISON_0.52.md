# MiraLink 0.52 / DS5Dongle comparison
...
| Axis | DS5Dongle | MiraLink 0.51 | MiraLink 0.52 | Evidence |
| --- | ---: | ---: | ---: | --- |
| Passive Bluetooth reconnect | 100% | 55% | 55% | Software correction built; physical result pending |
...
The 0.52 UF2 is 904,704 bytes versus 1,525,248 bytes for the DS5Dongle
