...
0.56 is a firmware candidate built from the current `main` source after a
...
- UF2 metadata: version 0.56, SDK 2.3.0, binary range `0x10000000..0x1006e78c`.

## Hardware boundary

No physical Pico 2 W / DualSense run has been performed with 0.56. Previous
v0.51 through v0.55 assets did not contain the complete 0.56 lifecycle change
and must not be used to evaluate this fix. Audio streaming remains disabled.

## Release artifact

`firmware/releases/0.56/miralink_pico_firmware.uf2` - 905,728 bytes
SHA-256: `E1A5E20085167FA8AF40D2E833EA19DB40CC3EFF49D1A2E059A6D25679045970`
