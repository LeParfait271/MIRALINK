...
`app/package.json` uses the valid npm semver representation `0.28.0`; this is
packaging metadata for the public site version `0.28`, not a separate product
release.
...
The current committed site version is `0.28`. The current firmware version is
