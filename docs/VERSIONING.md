...
`app/package.json` uses the valid npm semver representation `0.23.0`; this is
packaging metadata for the public site version `0.23`, not a separate product
release.
...
The current committed site version is `0.23`. The current firmware version is
