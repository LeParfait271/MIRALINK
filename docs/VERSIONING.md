...
`app/package.json` uses the valid npm semver representation `0.26.0`; this is
packaging metadata for the public site version `0.26`, not a separate product
release.
...
The current committed site version is `0.26`. The current firmware version is
