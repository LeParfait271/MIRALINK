# MiraLink 0.57 / DS5Dongle comparison
...
| Axis | DS5Dongle | MiraLink 0.56 | MiraLink 0.57 | Evidence |
| --- | ---: | ---: | ---: | --- |
| Passive Bluetooth reconnect | 100% | 55% | 55% | Gamepad ACL accepted without RAM-cache prerequisite, matching DS5Dongle; physical result pending |
...
The 0.57 UF2 is 905,728 bytes versus 1,525,248 bytes for the DS5Dongle
reference (59.4%). Size is informational only and is not part of the score.
