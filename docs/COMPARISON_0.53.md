# MiraLink 0.53 / DS5Dongle comparison
...
| Axis | DS5Dongle | MiraLink 0.52 | MiraLink 0.53 | Evidence |
| --- | ---: | ---: | ---: | --- |
| Passive Bluetooth reconnect | 100% | 55% | 55% | Authenticated inbound ACL admission/cache-rebuild correction built; physical result pending |
...
The 0.53 UF2 is 904,192 bytes versus 1,525,248 bytes for the DS5Dongle
